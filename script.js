...
form.addEventListener("submit", async (ev) => {
  ...
  try {
    ...
    if (cnpj) {
      ...
      // Pesquisa por cidade/estado/cnae (exemplo: endpoint fictício)
      statusEl.textContent = "Pesquisa por cidade/estado/cnae ainda não disponível na API pública. Use CNPJ.";
      return;
    }
  } catch (err) {
